...
namespace ChesApi.Infrastructure.Services.MoveStrategy
{
    public class QueenMoveStrategy : IFigureTypeMoveStrategy
    {
        ...
        {
            EnumDirection.Up => GlobalStrategyMethods.UpMovement(oldY, newX, newY, fieldsStatus),
            EnumDirection.Down => GlobalStrategyMethods.DownMovement(oldY, newX, newY, fieldsStatus),
            EnumDirection.Left => GlobalStrategyMethods.LeftMovement(oldX, newX, newY, fieldsStatus),
            EnumDirection.Right => GlobalStrategyMethods.RightMovement(oldX, newX, newY, fieldsStatus),
